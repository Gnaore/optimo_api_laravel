...
use App\Models\AuRebus as DataModel;
use App\Models\Immobilisation;
use Illuminate\Support\Facades\Validator;
use App\Models\AvantRebus;

class AuRebusController extends Controller
{
    /**
    ...
    public function update(Request $request, $id)
    {
        ...
        if(isset($request->reactivation) && (boolval($request->reactivation) == true && boolval($request->reactivation) == 1)){
