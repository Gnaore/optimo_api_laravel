        ...
        <div class="row align-items-center g-lg-5 py-5">
            <div class="col-lg-7 text-center text-lg-center">
                <div class="row text-center">
                    ...
                    <div class="col mt-2">
                        <img src="{{ asset('images/ltc.png') }}" width="90" height="90" class="img-thumbnail rounded rounded-circle" alt="perfect">
                    </div>
                </div>
            ...
            <div class="col-md-10 mx-auto col-lg-5 text-center">
                <form class="p-4 p-md-5 " style="font-family: 'Montserrat',Arial,sans-serif;" action="{{$url}}" method="POST">
                    ...
                    <br>
                    <span class="d-inline-block" id="myTooltip" tabindex="0" data-bs-toggle="tooltip" title="Copier l'adresse de paiement">
                    ...
                    <br>
                    <small style="color: red"><strong>Payez le montant exact indiqué en LTC</strong></small>
                    <br>
                    <small class="text-muted"> Cliquez pour continuer, une la transaction confirmée.</small>
                </form>
            </div>
        </div>
    </div>
